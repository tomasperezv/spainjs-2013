...
Spotify.Example = (function(namespace) {
    ...
    namespace.LocalStorage = {
			...
			/**
			 * Is more reliable to use the method performance.now from the
			 * HTLM5 Navigation API, but that's not available in every browser
			 * for that reason we do a fallback.
			 *
